...
def teleop(robot_side):
    ...
    puppet_bot = InterbotixManipulatorXS(robot_model="asratec_puppet", group_name="arm", gripper_name="gripper", robot_name=f'puppet_{robot_side}', init_node=True)
    master_bot = InterbotixManipulatorXS(robot_model="asratec_master", group_name="arm", gripper_name="gripper", robot_name=f'master_{robot_side}', init_node=False)
